...
model = pickle.load(open(r'knn_classifier_health.pkl', 'rb'))
...
def submit():
    ...
    names = ['Age', 'Disease','XrayReport','DuctFlow','ChestXray','LungFlow','RUQO2',
             'LowerBodyO2','HypoxiaInO2','CardiacMixing']
